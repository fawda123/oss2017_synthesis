...
```{r}
library(readr)
NodeTypes = read.csv("~/oss/oss2017_synthesis/Model/NodeClasses.csv")
...
```{r}
library(readxl)
DataFormat = read_xlsx("~/oss/oss2017_synthesis/data-raw/TestData1.xlsx") 
...
#Get inferences
set.seed(1) 
cpquery(dfit, event = (Sal=="HIGH"), evidence= (HR=="PRE"))
